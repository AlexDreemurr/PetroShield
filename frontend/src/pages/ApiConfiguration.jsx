...
const INITIAL_SERVICES = [
  ...
  { id: "dashscope", name: "视频AI识别", provider: "阿里云百炼 / 通义千问", icon: Sparkles, status: "服务端管理", enabled: true, endpoint: "https://dashscope.aliyuncs.com/compatible-mode/v1", model: "qwen3-vl-flash", timeout: 90, credential: "••••••••••••••••", env: "DASHSCOPE_API_KEY", description: "对上传的现场图片和短视频执行多模态安全识别，结果先进入疑似事件等待人工复核。", testable: false },
